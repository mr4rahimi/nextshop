...
سند [discounts.md](discounts.md) مدیریت تخفیف بازارگاه‌ها از پنل فروشگاه را
توضیح می‌دهد: مالکیت تخفیف روی هر لینک نگاشت، بازه‌ی زمانی، موجودی تخفیف‌دار، و
مسیر افزودن پلتفرم‌های بعدی.
