...
6. **فاز بعدی: ۵ — خزانه و چک.** فاکتورها `paidTotal` دارند که فعلاً همیشه صفر است؛ سرویس تخصیص فاز ۵ تنها نویسنده‌اش است (تله‌ی ۶). ابطال/ویرایش فاکتور پرداخت‌شده همین حالا با ۴۰۹ رد می‌شود.
