...
- `AccWarehouse`، `AccStock`، `AccProductCost`، `AccStockMove`؛ میانگین موزون،
  بازسازی با تاریخ گذشته، حواله، انبارگردانی؛ `Product.stock` از انبارهای قابل فروش.
- ✅ **وقتی:** سناریوی آزمون (خرید ۱۰ × ۱۰۰، خرید ۱۰ × ۱۲۰، فروش ۵، خرید با تاریخ
  قبل از فروش) میانگین و COGS درست می‌دهد؛ موجودی سایت با جمع انبارها برابر است.
