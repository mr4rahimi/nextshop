...
- هشدار: چند سایت روی یک سرور مشترک‌اند — هرگز pm2 restart all و دستکاری دیتابیس سایر سایت‌ها انجام نشود.

> **جزئیات کامل — جدول سایت‌ها/سرورها، راه‌اندازی سرور جدید از صفر، nginx، SSL
> پشت CDN، و عیب‌یابی — در [`deployment.md`](deployment.md) است.**
