...
const PLATFORM_NOTE: Record<string, string> = {
  ...
  basalam:
    "باسلام تخفیف را به‌صورت «کمپین» نگه می‌دارد و فقط درصد و «چند روز فعال بماند» می‌گیرد. تاریخ شروع را پنل ما اجرا می‌کند و تاریخ پایان به تعداد روز تبدیل می‌شود. مدیریت کمپین باید در فرم اتصال باسلام روشن شده باشد.",
};
