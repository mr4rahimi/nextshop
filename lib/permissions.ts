...
export const PERMISSION_GROUPS: PermissionGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { key: "ACC_SALES", label: "فاکتور فروش، پیش‌فاکتور و برگشت از فروش", hint: "ثبت، ویرایش، ابطال و چاپ" },
      ...
      { key: "ACC_EXPENSE", label: "ثبت و ابطال هزینه‌ها", hint: "اجاره، قبض، تبلیغات و … — نقد یا نسیه" },
      {
        ...
        hint: "سنی بدهی، هزینه‌ها، گردش صندوق و ارزش افزوده. سود و زیان، ترازنامه، تراز آزمایشی، سود کالا و ارزش موجودی مجوز «دیدن بهای تمام‌شده» را هم می‌خواهند",
      },
