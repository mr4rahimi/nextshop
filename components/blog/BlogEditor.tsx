...
export default function BlogEditor({ value, onChange, placeholder = "محتوای مطلب را بنویسید..." }: Props) {
  ...
  const inp = "border border-gray-200 dark:border-gray-700 rounded-lg px-3 py-1.5 text-sm bg-white dark:bg-gray-800 dark:text-white outline-none focus:border-blue-500 flex-1";
  ...
  return (
    <div className="border border-gray-200 dark:border-gray-700 rounded-2xl overflow-hidden bg-white dark:bg-gray-900">
      ...
      {/* popover لینک */}
      {showLink && (
        <div className="flex items-center gap-2 px-3 py-2 bg-blue-50 dark:bg-blue-900/20 border-b border-gray-200 dark:border-gray-700">
