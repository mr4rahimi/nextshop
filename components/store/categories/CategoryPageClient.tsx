        ...
        {priceOpen && (
          <div className="px-7 pb-8 pt-0 space-y-4">
            ...
            <button
              ...
              className="w-full py-4 bg-blue-600 hover:bg-blue-700 text-white rounded-[1.5rem] text-xs font-black transition-all active:scale-95"
            >
              تایید محدوده قیمت
            </button>
          </div>
            ...
            <div className="px-7 pb-8 space-y-5">
              {brands.length > 5 && (
                <div className="relative">
                  <input
                    type="text"
                    className="w-full bg-white/60 dark:bg-white/10 border border-gray-200 dark:border-white/20 rounded-2xl py-3.5 pr-11 pl-4 text-xs font-bold text-gray-800 dark:text-white outline-none transition-all focus:border-blue-500/50"
              ...
              <ul className="space-y-1 max-h-72 overflow-y-auto pl-2">
                {filteredBrands.map((b) => (
                  <li key={b.id} className="group/brand">
                    <label className="flex items-center justify-between p-3 rounded-2xl hover:bg-blue-500/5 dark:hover:bg-blue-500/10 cursor-pointer transition-all border border-transparent hover:border-blue-500/20">
                      <span className="text-xs font-bold text-gray-700 dark:text-gray-300 group-hover/brand:text-blue-600 transition-colors">
                        {b.title}
                      </span>
                      <div className="relative flex items-center">
                        <input
                          type="checkbox"
                          className="peer appearance-none w-5 h-5 rounded-lg border-2 border-gray-300/70 dark:border-white/20 checked:bg-blue-500 checked:border-blue-500 transition-all cursor-pointer"
      ...
      <section className="relative py-16">
        <div className="container px-4">
          ...
          <nav className="flex items-center gap-2 text-[10px] font-black text-gray-400 mb-6 bg-white/30 dark:bg-white/[0.02] w-fit px-4 py-2 rounded-full border border-white/40 dark:border-white/5 backdrop-blur-md">
            <Link href="/" className="hover:text-blue-500 transition-colors uppercase tracking-tighter">خانه</Link>
            ...
            {category.parent && (
              <>
                <Link href={`/categories/${category.parent.slug}`} className="hover:text-blue-500 transition-colors uppercase tracking-tighter">
            ...
            <div className="flex flex-wrap gap-3 mb-10">
              {category.children.map((child) => (
                <Link
                  ...
                  className="flex items-center gap-2 px-5 py-2.5 bg-white/50 dark:bg-white/5 border border-gray-200 dark:border-white/10 rounded-2xl text-sm font-bold text-gray-700 dark:text-gray-300 hover:border-blue-500 hover:text-blue-600 transition-all"
                >
                  {child.imageUrl && (
                    ...
                    <div className="mt-16 flex items-center justify-center">
                      <div className="flex items-center gap-2 bg-white/40 dark:bg-white/[0.03] backdrop-blur-2xl border border-white/40 dark:border-white/10 p-2 rounded-[2rem] shadow-xl shadow-gray-200/40 dark:shadow-none">
                        ...
                        <button
                          ...
                          disabled={page === 1}
                          className="w-11 h-11 rounded-[1.2rem] bg-white/50 dark:bg-white/5 border border-gray-100 dark:border-white/5 flex items-center justify-center text-gray-400 hover:text-blue-500 hover:bg-white dark:hover:bg-white/10 transition-all disabled:opacity-40 disabled:cursor-not-allowed"
                        >
                          <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            return (
                              <button
                                ...
                                className={`w-11 h-11 rounded-[1.2rem] flex items-center justify-center text-xs font-black transition-all ${
                                  page === p
                                    ? "bg-blue-500 text-white shadow-lg shadow-blue-500/40 ring-4 ring-blue-500/10"
                                    : "bg-white/60 dark:bg-white/10 border border-white dark:border-white/5 text-gray-600 dark:text-gray-300 hover:bg-blue-500 hover:text-white"
                                }`}
                              >
                                {toFarsi(p)}
                              </button>
                          ...
                          {totalPages > INFINITE_SCROLL_LIMIT + 7 && (
                            <>
                              ...
                              <button
                                ...
                                className="w-11 h-11 rounded-[1.2rem] bg-white/60 dark:bg-white/10 border border-white dark:border-white/5 flex items-center justify-center text-xs font-black text-gray-600 dark:text-gray-300 hover:bg-blue-500 hover:text-white transition-all"
                              >
                                {toFarsi(totalPages)}
                              </button>
                            </>
