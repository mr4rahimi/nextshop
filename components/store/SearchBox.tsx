                      ...
                      <div className="flex flex-wrap gap-2">
                        ...
                        {result.suggestions.brands.map(b => (
                          <Link key={b.slug} href={`/brands/${b.slug}`} onClick={() => setOpen(false)}
                            ...
                            {b.logoUrl
                              ? <Image src={b.logoUrl} alt={b.title} width={16} height={16} className="object-contain" />
                        ...
                        {result.products.map((p, i) => {
                          ...
                          return (
                            <Link key={p.id} href={`/products/${p.slug}`}
                              ...
                              {}
                              <div className="relative w-14 h-14 rounded-2xl bg-gray-50 dark:bg-gray-800 border border-gray-100 dark:border-white/5 flex items-center justify-center overflow-hidden flex-shrink-0">
                                {img
                                  ? <Image src={img} alt={p.title} fill className="object-contain p-1" sizes="56px" />
