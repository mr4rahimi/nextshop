...
export default function CartIcon() {
  const { count } = useCart();
  return (
    <Link href="/cart" aria-label="سبد خرید" className="relative flex items-center justify-center w-11 h-11 rounded-2xl bg-white/40 dark:bg-white/5 border border-white/60 dark:border-white/10 text-gray-600 dark:text-gray-300 hover:text-primary-600 transition-all">
