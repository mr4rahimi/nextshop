      ...
      <div className="group relative h-full pt-12">
        ...
        <Link href={`/products/${product.slug}`} className="relative p-7 flex flex-col h-full z-10 transition-transform duration-500 group-hover:-translate-y-4">
          ...
          <div className="relative mb-8 h-44">
            <div className="absolute inset-0 m-auto w-40 h-40 bg-primary-500/20 dark:bg-primary-500/20 blur-[70px] rounded-full opacity-0 group-hover:opacity-100 transition-all duration-1000" />

            {product.image ? (
              <Image src={product.image} alt={product.title} fill
                className="object-contain z-10 transition-all duration-700 group-hover:scale-110 group-hover:drop-shadow-[0_15px_35px_rgba(37,99,235,0.3)]"
        ...
        <div className="container pb-7 relative z-10">
          ...
          <div className="flex items-end justify-between mb-6 gap-4 flex-wrap">
            <div className="flex items-center gap-6">
              {/* Icon */}
              <div className="relative w-16 h-16 bg-white dark:bg-black border border-gray-100 dark:border-primary-500/40 rounded-[1.8rem] flex items-center justify-center text-primary-600 shadow-2xl">
